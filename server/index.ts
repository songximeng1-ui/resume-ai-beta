  ...
  const plans =
    route === 'applying_no_feedback'
      ? [
          actionPlanItem(
            '7 天内',
            '整理最多 3 条投递记录，记录岗位、简历版本、投递时间、反馈状态和可疑线索。',
            '先复盘事实，不评价用户本人。',
            '只记录最近 3 条，不扩大成完整 CRM，也不要求补充无关隐私。',
            '完成最多 3 条投递记录。',
            '判断问题可能在材料、岗位、节奏还是市场反馈。'
          ),
          actionPlanItem(
            '7 天内',
            '把最近一次投递和使用的简历版本对上，标出最可能没说清的一条证据。',
            '检查投递材料是否回应岗位要求。',
            '只选一条经历表达做对照，记录岗位要求、简历写法和反馈状态。',
            '找到 1 条可修改线索。',
            '下一轮只改一个小点再观察。'
          ),
          actionPlanItem(
            '14 天内',
            '小范围调整 1 个岗位类型或 1 条简历表达。',
            '避免无目标加量投递。',
            '只选择一个变量调整，并继续记录岗位、简历版本、投递时间、反馈状态和可疑线索。',
            '完成 1 次可复盘调整。',
            '让后续复盘更清楚。'
          ),
          actionPlanItem(
            ...
            '针对可疑线索只改 1 条简历表达。',
            '让调整可复盘。',
            '保留原版本，记录修改前后差异，不同时改多个模块。',
            '完成 1 次简历小改。',
            '观察下一轮反馈是否变化。'
          ),
          actionPlanItem(
            '30 天内',
            '用同一张记录表复盘下一轮最多 3 次投递。',
            '比较调整前后的反馈状态。',
            '继续记录岗位、简历版本、投递时间、反馈状态和可疑线索。',
            '完成第二轮最多 3 条记录。',
            '判断是否需要换岗位样本或改材料。'
          ),
          actionPlanItem(
